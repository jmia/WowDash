...
{
    [TestFixture]
    public class RefreshWeeklyTaskCharactersTests : UnitTestBase
    {
        ...
        [Test]
        public void GivenACollectionOfWeeklyRecurringTasks_SetsAllTaskCharactersToActive()
        {
            // Arrange
            ...
            // Act
            var result = _controller.RefreshWeeklyTaskCharacters();
        ...
        [Test]
        public void GivenACollectionOfSomeWeeklyRecurringTasks_SetsOnlyDailyTaskCharactersToActive()
        {
            // Arrange
            var firstTask = new Task(DefaultPlayer.Id, TaskType.General);
            var secondTask = new Task(DefaultPlayer.Id, TaskType.General);
        ...
        [Test]
        public void GivenACollectionWithNoWeeklyRecurringTasks_SetsNoTaskCharactersToActive()
        {
            // Arrange
            var firstTask = new Task(DefaultPlayer.Id, TaskType.General);
            var secondTask = new Task(DefaultPlayer.Id, TaskType.General);
